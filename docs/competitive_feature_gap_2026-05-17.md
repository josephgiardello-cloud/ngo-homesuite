...
| CardDAV/CalDAV sync | Exists | `ngo_homesuite/web/integrations_routes.py`, `ngo_homesuite/services/calendar_sync_service.py`, `ngo_homesuite/web/test_integrations_routes.py` | Dedicated CalDAV and CardDAV sync routes with dry-run support, provider-state capability reporting, and integration operations telemetry are implemented and route-tested. |
