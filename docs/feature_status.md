...
| End-to-end integration journeys | Partial | Foundational | Legacy integration-journey test module is currently skipped; replacement end-to-end journey coverage is still needed for release confidence. |
