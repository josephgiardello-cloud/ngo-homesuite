...
ROUTE_POLICY_MANIFEST: dict[str, RoutePolicy] = {
    ...
    "/admin/grants/intelligence": RoutePolicy(access="admin"),
    "/admin/grants/list": RoutePolicy(access="admin"),
    "/admin/grants/opportunities/search": RoutePolicy(access="admin"),
    ...
    "/ai/conversation/current": RoutePolicy(access="authenticated"),
    "/ai-assistant-hub": RoutePolicy(access="authenticated"),
    ...
    "/api/ui/profile": RoutePolicy(access="authenticated"),
    ...
    "/api/v2/campaigns/email/preferences": RoutePolicy(access="tokenized_public"),
    "/api/v2/campaigns/email/segments": RoutePolicy(access="authenticated"),
    "/api/v2/campaigns/email/unsubscribe": RoutePolicy(access="tokenized_public"),
    "/api/v2/collab/channels": RoutePolicy(access="authenticated"),
    "/api/v2/collab/inbox": RoutePolicy(access="authenticated"),
    "/api/v2/collab/presence": RoutePolicy(access="authenticated"),
    "/api/v2/donor-journeys/automations/events": RoutePolicy(access="authenticated"),
    "/api/v2/forms/submissions": RoutePolicy(access="authenticated"),
    "/api/v2/intelligence/dashboard": RoutePolicy(access="authenticated"),
    "/api/v2/intelligence/financial-guardrails": RoutePolicy(access="authenticated"),
    ...
    "/api/v2/dedupe/workbench": RoutePolicy(access="authenticated"),
    ...
    "/api/v2/grants/external/grants-gov/search": RoutePolicy(access="authenticated"),
    "/api/v2/grants/opportunities/search": RoutePolicy(access="authenticated"),
    ...
    "/api/v2/projects/portfolio/overview": RoutePolicy(access="authenticated"),
    "/api/v2/smart-groups": RoutePolicy(access="authenticated"),
    "/api/v2/tasks": RoutePolicy(access="authenticated"),
    "/api/v2/task-assignees": RoutePolicy(access="authenticated"),
    "/api/v2/tasks/overdue-summary": RoutePolicy(access="authenticated"),
    "/api/events": RoutePolicy(access="authenticated"),
    "/auth/login": RoutePolicy(access="public"),
    "/auth/mfa/setup": RoutePolicy(access="authenticated"),
    "/auth/oauth/providers": RoutePolicy(access="public"),
    "/auth/password/forgot": RoutePolicy(access="public"),
    ...
    "/dashboard/export": RoutePolicy(access="authenticated"),
    ...
    "/events": RoutePolicy(access="authenticated"),
    ...
    "/integrations-hub": RoutePolicy(access="authenticated"),
    ...
    "/integrations/dav/capabilities": RoutePolicy(access="authenticated"),
    ...
    "/tony/": RoutePolicy(access="authenticated"),
    "/tony/api/baselines": RoutePolicy(access="authenticated"),
    "/tony/api/config": RoutePolicy(access="authenticated"),
    "/tony/calibrate": RoutePolicy(access="authenticated"),
    "/tony/compliance": RoutePolicy(access="authenticated"),
    "/tony/dashboard": RoutePolicy(access="authenticated"),
    "/tony/evaluate": RoutePolicy(access="authenticated"),
    "/tony/ingest": RoutePolicy(access="authenticated"),
    "/tony/report": RoutePolicy(access="authenticated"),
    "/tony/score": RoutePolicy(access="authenticated"),
