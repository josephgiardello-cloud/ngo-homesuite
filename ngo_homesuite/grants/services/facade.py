...
class GrantsFacade:
    ...
    calibrate_external_opportunity = staticmethod(PreawardService.calibrate_external_opportunity)
    import_external_opportunity = staticmethod(PreawardService.import_external_opportunity)
    import_grants_gov_opportunities = staticmethod(PreawardService.import_grants_gov_opportunities)
